...
// This code send and receive random number from slave device and shows it in LCD with I2C
// Then esp send this random to serial (UART) and shows the equal in ascii
